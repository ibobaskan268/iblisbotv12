...
exports.run = (client, message, args) => {
  ...
  if (message.mentions.users.size < 1) return message.reply('Kimin kafasınası kacağını yazmalısın.').catch(console.error);
    message.channel.send('Kafasına sıkılıyor....')
     ...
     var Random = [
      'Tam isabet knk aimbot açtıysan kapa niyese her vurduğun hs gidiyoda ondan söyledim :joy: :D xD qwqeglsdghdshgdlshgdlghgdlsjgh',
      'Silah Tutukluluk Yaptı Ya, Tekrar Dene Knk.',
    ];
