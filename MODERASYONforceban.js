           ...
           .then(bans => {
               ...
               message.guild.members.ban(seyfooo, sebeb)
                   .then(async (member) => {
                       ...
                       message.channel.send(`<@!${user.id}> adlı kullanıcı banlandı <:745448089048842321:826438946275065896>`);
                   })
                   .catch(error => {
           ...
           .then(bans => {
               ...
               message.guild.ban(seyfooo, sebeb)
                   .then(async (member) => {
                       ...
                       message.channel.send(`<@!${user.id}> sunucudan yasaklandı <:745448089048842321:826438946275065896>`);
                   })
                   .catch(error => {
