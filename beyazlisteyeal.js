...
if(message.author.id !== "683707976468398227") if(message.author.id !== "589499166971920394") return message.channel.send(":x: Bu komutu sadece sahiplerim kullanabilir.")
